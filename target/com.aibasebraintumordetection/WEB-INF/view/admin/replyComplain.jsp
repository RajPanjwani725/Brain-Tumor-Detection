...
<body class="fixed-left">
							...
							<div class="col-md-12 col-xl-12">
								<div class="card m-b-30">
									<div class="card-body">
										...
										<f:form onsubmit=" return validateTableDetais()" class="" action="saveComplainReply" method="post" modelAttribute="complainVO">
										...
										<f:hidden path="loginVO.loginId"/>
											...
											<div class="form-group">
												<label>Complain Subject</label> <f:input path="complainSubject" name="complainSubject" id="complainSubject" disabled="true"
													class="form-control" />
											</div>
											...
											<div class="form-group">
												...
												<div>
													<f:textarea path="complainDescription" name="complainDescription"  id="complainDescription"  class="form-control" rows="5" disabled="true"></f:textarea>
												</div>
											</div>

											<div class="form-group">
												<label>Complain Reply </label>
												<div>
													<f:textarea path="complainReply"  name="complainReply"  id="complainReply"    class="form-control" rows="5" />
												</div>
											</div>
	...
	<script
		src="<%=request.getContextPath()%>/adminResources/js/custom/replyComplainValidation.js"></script>
