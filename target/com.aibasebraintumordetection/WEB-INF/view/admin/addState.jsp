...
<body class="fixed-left">
							...
							<div class="col-md-12 col-xl-12">
								<div class="card m-b-30">
									<div class="card-body">
										...
										<f:form onsubmit="return validateTableDetais()" class="" action="saveState" method="post" modelAttribute="stateVO">
											<f:hidden path="id"/>
											<div class="form-group">
												<label>State Name</label>
												<f:input path="stateName" name="stateName" id="stateName"
													class="form-control"   />
											</div>
	...
	<script
		src="<%=request.getContextPath()%>/adminResources/js/custom/StateValidation.js"></script>
