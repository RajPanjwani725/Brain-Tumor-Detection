...
<body class="fixed-left">
							...
							<div class="col-md-12 col-xl-12">
								<div class="card m-b-30">
									<div class="card-body">
										...
										<f:form onsubmit="return validateTableDetais()"  class="" action="savePackage" method="post"
											modelAttribute="packageVO">
											<f:hidden path="id"/>

											<div class="form-group">
											
												<label>Package Name</label>
												<f:input path="packageName" name="packageName"  
													id="packageName" class="form-control" />
											</div>
											...
											<div class="form-group">
											 ...
											 <div class="col-md-0 offset-md-12">
													<div class="input-group mt-2">
														...
														<f:input path="packagePrice" id="packagePrice"
															 name="packagePrice" class="form-control"    />
											...
											<div class="form-group">
												...
												<f:input path="packageDuration" name="packageDuration"  
													class="form-control" 
													id="packageDuration" />
											</div>
											...
											<div class="form-group">
												...
												<div>
													<f:textarea path="packageDescription"
														name="packageDescription" id="packageDescription"
	...
	<script
		src="<%=request.getContextPath()%>/adminResources/js/custom/PackageValidation.js"></script>
</body>
</html>