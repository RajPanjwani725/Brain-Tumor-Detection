...
<title>Admin  |  Page Profile</title>
...
<body class="fixed-left">
	...
	<div id="wrapper">
		...
		<div class="content-page">
								...
								<div class="card m-b-30">
									<div class="card-body">
										...
										<div class="text-center">
											<h5 class="mt-2 mb-0">Robert N. Carlile</h5>
											<small class="text-muted">Founder of Company</small>
											<p class="text-muted mb-2 p-2">Hi I'm Robert Carlile,has
											...
											<div class="card-body">
												...
												<ul class="list-unstyled mb-0">
													...
													<li class="mt-2"><i class="far fa-envelope mt-2 mr-2"></i>
														<b>Email </b>: example123@gmail.com</li>
													<li class="mt-2"><i
										...
										<div class="card m-b-30">
											<div class="card-body">
												...
												<div class="row text-center">
													<div class="col-sm-12">
														<a href="#"><img
															src="<%=request.getContextPath()%>/adminResources/image/avatar-9.jpg" alt=""
															class="friend-img rounded mx-1"></a><a href="#"><img
															src="<%=request.getContextPath()%>/adminResources/image/avatar-8.jpg" alt=""
															class="friend-img rounded mx-1"></a><a href="#"><img
															src="<%=request.getContextPath()%>/adminResources/image/avatar-7.jpg" alt=""
															class="friend-img rounded mx-1"></a><a href="#"><img
															src="<%=request.getContextPath()%>/adminResources/image/avatar-6.jpg" alt=""
															class="friend-img rounded mx-1"></a>
													</div>
													<div class="col-sm-12 my-2">
														<a href="#"><img
															src="<%=request.getContextPath()%>/adminResources/image/avatar-5.jpg" alt=""
															class="friend-img rounded mx-1"></a><a href="#"><img
															src="<%=request.getContextPath()%>/adminResources/image/avatar-4.jpg" alt=""
															class="friend-img rounded mx-1"></a><a href="#"><img
															src="<%=request.getContextPath()%>/adminResources/image/avatar-3.jpg" alt=""
															class="friend-img rounded mx-1"></a><a href="#"><img
															src="<%=request.getContextPath()%>/adminResources/image/avatar-2.jpg" alt=""
															class="friend-img rounded mx-1"></a>
													</div>
												</div>
											</div>
								...
								<div class="card m-b-30">
									<div class="card-header profile-tabs pb-0">
										<ul class="nav nav-tabs">
											...
											<li class="nav-item"><a class="nav-link" href="#photo"
												data-toggle="tab" aria-expanded="false"><i
													class="ti-image mr-2"></i>Photos</a></li>
												...
												<div class="tab-pane active pt-3" id="about">
													<div class="row justify-content-center">
														...
														<div class="col-md-12 col-lg-8 align-self-center">
															<p class="detail-text">Sed ut perspiciatis unde omnis
															...
															<ul class="list-unstyled presonal-inform mt-3">
																<li><b>Name:</b>Robert N. Carlile</li>
														...
														<div class="col-md-12 col-lg-4 align-self-center">
															<h6 class="mt-3">
																<i class="ti ti-css3 pr-2"></i>Css3 <span
																	class="float-right">88%</span>
															</h6>
															...
															<h6 class="mt-3">
																<i class="ti ti-html5 pr-2"></i>HTML5 <span
																	class="float-right">82%</span>
															</h6>
															<div class="progress mt-3">
															...
															<h6 class="mt-3">
																<i class="ti ti-wordpress pr-2"></i>Wordpress <span
																	class="float-right">77%</span>
															</h6>
															<div class="progress mt-3">
															...
															<h6 class="mt-3">
																<i class="ti ti-android pr-2"></i>Android <span
												...
												<div class="tab-pane" id="photo">
													...
													<div class="row px-3">
														<div class="col-lg-3 col-md-6 p-0">
															<div class="item-box">
																<a class="mfp-image img-fluid"
																	href="<%=request.getContextPath()%>/adminResources/image/img-1.jpg" title="30 min ago"><img
																	class="item-container img-fluid"
																	src="<%=request.getContextPath()%>/adminResources/image/img-1.jpg" alt="7"></a>
															</div>
														</div>
														<div class="col-lg-3 col-md-6 p-0">
															<div class="item-box">
																<a class="mfp-image img-fluid"
																	href="<%=request.getContextPath()%>/adminResources/image/img-7.jpg" title="yesterday"><img
																	class="mfp-fade img-fluid"
																	src="<%=request.getContextPath()%>/adminResources/image/img-7.jpg" alt="2"></a>
															</div>
														</div>
														<div class="col-lg-3 col-md-6 p-0">
															<div class="item-box">
																<a class="mfp-image img-fluid"
																	href="<%=request.getContextPath()%>/adminResources/image/img-6.jpg" title="3 day ago"><img
																	class="img-fluid" src="<%=request.getContextPath()%>/adminResources/image/img-6.jpg"
																	alt="4"></a>
															</div>
														</div>
														<div class="col-lg-3 col-md-6 m-0 p-0">
															<div class="item-box">
																<a class="mfp-image img-fluid"
																	href="<%=request.getContextPath()%>/adminResources/image/img-5.jpg" title="last week"><img
																	class="img-fluid" src="<%=request.getContextPath()%>/adminResources/image/img-5.jpg"
																	alt="5"></a>
															</div>
														</div>
														<div class="col-lg-3 col-md-6 p-0">
															<div class="item-box">
																<a class="mfp-image img-fluid"
																	href="<%=request.getContextPath()%>/adminResources/image/img-4.jpg" title="last month"><img
																	class="img-fluid" src="<%=request.getContextPath()%>/adminResources/image/img-4.jpg"
																	alt="6"></a>
															</div>
														</div>
														<div class="col-lg-3 col-md-6 p-0">
															<div class="item-box">
																<a class="cbox-gallary1 mfp-image img-fluid"
																	href="<%=request.getContextPath()%>/adminResources/image/img-3.jpg" title="last year"><img
																	class="img-fluid" src="<%=request.getContextPath()%>/adminResources/image/img-3.jpg"
																	alt="1"></a>
															</div>
														</div>
														<div class="col-lg-3 col-md-6 p-0">
															<div class="item-box">
																<a class="img-fluid mfp-image"
																	href="<%=request.getContextPath()%>/adminResources/image/img-2.jpg" title="30 min ago"><img
																	class="img-fluid" src="<%=request.getContextPath()%>/adminResources/image/img-2.jpg"
																	alt="7"></a>
															</div>
														</div>
														<div class="col-lg-3 col-md-6 p-0">
															<div class="item-box">
																<a class="img-fluid mfp-image"
																	href="<%=request.getContextPath()%>/adminResources/image/img-1.jpg" title="yesterday"><img
																	class="img-fluid mfp-fade"
																	src="<%=request.getContextPath()%>/adminResources/image/img-1.jpg" alt="2"></a>
															</div>
														</div>
													</div>
															...
															<div class="">
																<form class="form-horizontal form-material">
																	...
																	<div class="form-group row">
																		...
																		<div class="col-sm-6">
																			<select class="form-control"><option>London</option>
																				<option>India</option>
																				<option>Usa</option>
																				<option>Canada</option>
																				<option>Thailand</option></select>
																		</div>
																	</div>
																	<div class="form-group">
			...
			<!-- content -->
			<footer class="footer">© 2018 - 2020 Dashor by Themesdesign.</footer>
		</div>
