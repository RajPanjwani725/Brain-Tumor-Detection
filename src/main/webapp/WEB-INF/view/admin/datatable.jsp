							...
							<div class="col-md-12">
								<div class="card m-b-30">
									<div class="card-body table-responsive">
										...
										<div class="">
											<table id="datatable2"
												class="table border-0 dt-responsive nowrap" cellspacing="0"
												width="100%">
												<thead>
													<tr class="">
														<th>Name</th>
							...
							<div class="col-md-12">
								<div class="card">
									<div class="card-body">
										...
										<p class="text-muted font-14">The Buttons extension for
											DataTables provides a common set of options, API methods and
											styling to display buttons on a page that will interact with
											a DataTable. The core library provides the based framework
