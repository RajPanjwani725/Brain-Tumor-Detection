...
<div class="col-sm-12">
								<div class="page-title-box">
									...
									<h1 class="page-title" style="text-align: center; font-size: 50px">Buy Package</h1>
								</div>
							</div>
								...
								<c:forEach items="${packageList }" var="i">
									<div class="pricing card-deck flex-column flex-md-row mb-3">
										...
										<div class="card card-pricing text-center px-3 mb-4">
											<span
												class="h2 w-100 mx-auto  rounded-bottom bg-primary text-white shadow-sm">${i.packageName}</span>
											<div class="bg-transparent card-header pt-4 border-0">
												<h1
													class="h3 font-weight-normal text-primary text-center mb-0"
													data-pricing-value="15">
													$<span class="price">${i.packageDuration }</span>
												</h1>
											</div>
											<div class="card-body pt-0">
												<ul class="list-unstyled mb-4"><h3>${i.packageDescription }</h3>
												</ul>
													<a href="pageMaintenance"><button type="button" class="btn btn-outline-secondary mb-3">
											 Order
													now</button></a>
											</div>
										</div>
