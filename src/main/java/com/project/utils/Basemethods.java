...
public class Basemethods {
	...
	public static void sendMail(String email, String OTP) {
		...
		try {
			...
			InternetAddress sender = new InternetAddress("From :- EMAILID@gmail.com", "Password(message)");
			...
			transport.connect("smtp.gmail.com", 587, "From :- EMAILID@gmail.com", "password of email");
